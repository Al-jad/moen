<template>
    <div class="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto bg-white shadow sm:rounded-lg p-8">
            ...
            <section class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">2. Use of the Site</h2>
                <p class="text-gray-700 mb-4">
                    ...
                    content, or disrupting the normal flow of dialogue within our Site.
                </p>
            </section>
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700">
                    ...
                    your password and for all activities that occur under your account. You agree to notify us
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700">
                    ...
                    access to or use of our servers and/or any personal information stored therein; and (iii) any bugs,
                    viruses, trojan horses, or the like that may be transmitted to or through our Site by any third
                    party.
                </p>
            </section>

            <section class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">7. Governing Law</h2>
                <p class="text-gray-700">
            ...
            <section class="mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">8. Changes to the Terms</h2>
                <p class="text-gray-700">
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700">
                    If you have any questions about these Terms, please <router-link to="/contact"
                        class="text-gray-700 inline underline">
                        <span>
                            contact us
                        </span>
                    </router-link>
